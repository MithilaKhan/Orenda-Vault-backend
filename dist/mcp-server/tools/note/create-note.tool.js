...
function createNoteTool(server) {
    server.registerTool("createNote", {
        ...
        inputSchema: {
            ...
            collectionId: zod_1.default.string().optional().describe("The unique identifier (MongoDB Object ID) of the collection where this note will be saved. Omit or pass null if you don't want to choose any collection."),
