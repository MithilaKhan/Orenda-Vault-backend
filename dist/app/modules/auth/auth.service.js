...
const resetPasswordToDB = (token, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!isExistToken) {
        throw new ApiError_1.default(http_status_codes_1.StatusCodes.UNAUTHORIZED, `You are not authorized. Invalid token: '${token}'`);
    }
    ...
    const hashPassword = yield bcrypt_1.default.hash(String(newPassword), Number(config_1.default.bcrypt_salt_rounds));
    const updateData = {
