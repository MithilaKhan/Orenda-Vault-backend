...
const createCollectionToDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (isExistNote) {
        throw new ApiError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, "A Note with this name already exists! Notes and Collections cannot share the same title.");
    }
...
const getCollectionByIdToDB = (id, userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return Object.assign(Object.assign({}, isCollection.toObject()), { notes });
});
/**
