...
const processChatMessage = (messages) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d;
    ...
    if (outputData) {
        const toolRes = yield mcp_tools_call_1.callMcpToolsClient.callTool(outputData.name, outputData.arguments);
