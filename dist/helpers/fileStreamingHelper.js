...
exports.fileStreamHandler = void 0;
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
const mime_1 = __importDefault(require("mime"));
const fileStreamHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { folder, file } = req.params;
        // Resolve file path
        const filePath = path_1.default.join(process.cwd(), 'uploads', folder, file);
...
exports.fileStreamHandler = fileStreamHandler;
